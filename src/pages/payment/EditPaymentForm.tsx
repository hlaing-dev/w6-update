import { Button, Input, ImagePicker, Picker } from "@arco-design/mobile-react";
...
const EditPaymentForm = ({
  ...
  const [country, setCountry] = useState(initialData?.country || ["Myanmar"]);
  const [payment, setPayment] = useState(initialData?.type || ["Kpay"]);
  ...
  useEffect(() => {
    // Set images if initialData has any
